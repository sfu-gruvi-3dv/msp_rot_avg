...
class OneDSFMDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return imgs, cam_Es, cam_Cs, out_graph_mat, img_id2sub_id, sub_id2img_id, out_covis_mat
...
if __name__ == '__main__':
    ...
    imgs, cam_Es, cam_Cs, out_graph_mat, img_id2sub_id, sub_id2img_id = dataset[0]
    print(cam_Cs)