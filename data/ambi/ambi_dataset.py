...
class AmbiDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        batch_idx, batch_imgs = imgs2batchsamesize(imgs)
        return batch_idx, batch_imgs, cam_Es, cam_Cs, out_graph_mat, img_id2sub_id, sub_id2img_id
