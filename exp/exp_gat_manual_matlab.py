...
from exp.rot_avg_trainbox import LocalGlobalVLADTrainBox as LocalGlobalGATTrainBox
...
checkpoint_dict = {
    ...
    'ckpt': '/mnt/Exp_4/rot_avg_logs/Jul30_23-28-27_cs-gruvi-24-cmpt-sfu-ca_local_appear_nogat_rot_avg/checkpoints/iter_024000.pth.tar'
}
...
for s_itr, sample in enumerate(itr):
    img_names, img_lists, img_dims, Es, Cs, Ks, out_graph, sub2id, id2sub, covis_mat, e_node_idx, edge_label, e_keypt_n1, e_keypt_n2, e_rel_Rt = sample    

    print('Outliers:', (edge_label == 0).sum(), 'Inliers:', (edge_label == 1).sum())
    # found = False
    ...
    sio.savemat('/mnt/Exp_5/vis/to_matlab.mat', {
        'edge_idx': mat_edge_idx,
        'edge_rel_R': mat_edge_rel_R,
        'init_R': mat_init_R,
        'pred_R': mat_pred_R,   # camera -> world
        'gt_R': mat_gt_R
    })
