...
if 'cs-gruvi-24s' in server_name:
    ...
    yfcc_node_feat_lmdb = '/mnt/Tango/yfcc100/64_node_edge_feat.lmdb'
...
def make_dataset():
    ...
    train_yfcc = CaptureDataset(dataset_dir=yfcc_res_dir,
                                ...
                                sample_res_cache=os.path.join(yfcc_res_dir, 'train_sample_64_nodes.bin'),
                                sampling_num_range=[50, 80],
                                load_img=False,
    ...
    valid_yfcc = CaptureDataset(dataset_dir=yfcc_res_dir,
                                ...
                                img_lmdb_paths=yfcc_lmdb_cache,
                                node_edge_lmdb_path=yfcc_node_feat_lmdb,
                                sample_res_cache=os.path.join(yfcc_res_dir, 'valid_sample_64_nodes.bin'),
                                sampling_num_range=[20, 30],
                                load_img=False,
                                load_keypt_match=False,
                                load_node_edge_feat=True,
