...
import sys
<<<<<<< HEAD
sys.path.append("/mnt/Tango/pg/pg_akt_same_size/")
=======
>>>>>>> e8f4a6170e7e2d94c78bfa40e98bbc162e76efa9
from torch.utils.data import ConcatDataset
sys.path.append("/local-scratch7/pg_akt_same_size_test")
from core_dl.train_params import TrainParameters
from data.capture.capture_dataset_nonimage_10x_edges import CaptureDataset_10x_edges
...
>>>>>>> e8f4a6170e7e2d94c78bfa40e98bbc162e76efa9
    ...
    # 1dsfm dataset dir
    onedsfm_res_dir = '/local-scratch6/onedsfm_train'
...
def make_dataset():
    ...
    #                                  sub_graph_nodes=30)
    #
    valid_o_dataset = CaptureDataset_10x_edges(dataset_dir=onedsfm_res_dir,
                                dataset_list=valid_o_datalist,
                                img_max_dim=400,
                                img_lmdb_paths=yfcc_lmdb_cache,
                                sample_res_cache=os.path.join(onedsfm_res_dir, 'outlier_valid_30.bin'),
    ...
    yfcc_train_list = [
        ...
        {'name': 'lincoln_memorial_statue',
            'bundle_prefix': 'yfcc', 'valid_num': 745},
        {'name': 'florence_cathedral_side',
            'bundle_prefix': 'yfcc', 'valid_num': 103},
        ...
        {'name': 'blue_mosque_interior_1',
            'bundle_prefix': 'yfcc', 'valid_num': 432},
        {'name': 'taj_mahal',    'bundle_prefix': 'yfcc', 'valid_num': 1223},
        {'name': 'statue_of_liberty_2',    'bundle_prefix': 'yfcc', 'valid_num': 100},
        {'name': 'notre_dame_rosary_window',
            'bundle_prefix': 'yfcc', 'valid_num': 496},
        {'name': 'louvre',    'bundle_prefix': 'yfcc', 'valid_num': 624},
        {'name': 'colosseum_exterior',    'bundle_prefix': 'yfcc', 'valid_num': 1881},
        {'name': 'old_town_square_prague',
            'bundle_prefix': 'yfcc', 'valid_num': 1120},
        {'name': 'blue_mosque_interior_2',
            'bundle_prefix': 'yfcc', 'valid_num': 166},
        {'name': 'big_ben_1',    'bundle_prefix': 'yfcc', 'valid_num': 188},
        {'name': 'sagrada_familia_3',    'bundle_prefix': 'yfcc', 'valid_num': 170},
        {'name': 'palace_of_versailles_chapel',
            'bundle_prefix': 'yfcc', 'valid_num': 136},
        {'name': 'st_pauls_cathedral',    'bundle_prefix': 'yfcc', 'valid_num': 550},
        {'name': 'natural_history_museum_london',
            'bundle_prefix': 'yfcc', 'valid_num': 43},
        ...
        {'name': 'grand_central_terminal_new_york',
            'bundle_prefix': 'yfcc', 'valid_num': 216},
        {'name': 'st_peters_square',    'bundle_prefix': 'yfcc', 'valid_num': 2264},
        {'name': 'grand_place_brussels_1',
            'bundle_prefix': 'yfcc', 'valid_num': 406},
        {'name': 'old_town_square_prague_clock',
            'bundle_prefix': 'yfcc', 'valid_num': 981},
        {'name': 'grand_place_brussels_2',
            'bundle_prefix': 'yfcc', 'valid_num': 330},
        {'name': 'london_bridge_2',    'bundle_prefix': 'yfcc', 'valid_num': 185},
        {'name': 'florence_cathedral_dome_interior_2',
            'bundle_prefix': 'yfcc', 'valid_num': 246},
        {'name': 'palace_of_westminster',
            'bundle_prefix': 'yfcc', 'valid_num': 875},
        {'name': 'brandenburg_gate',    'bundle_prefix': 'yfcc', 'valid_num': 1177},
        {'name': 'pantheon_exterior',    'bundle_prefix': 'yfcc', 'valid_num': 1264},
        {'name': 'florence_cathedral_dome_interior_1',
            'bundle_prefix': 'yfcc', 'valid_num': 317},
        {'name': 'mount_rushmore',    'bundle_prefix': 'yfcc', 'valid_num': 124},
        {'name': 'statue_of_liberty_1',    'bundle_prefix': 'yfcc', 'valid_num': 90},
        {'name': 'sistine_chapel_ceiling_1',
            'bundle_prefix': 'yfcc', 'valid_num': 71},
        {'name': 'palazzo_pubblico',    'bundle_prefix': 'yfcc', 'valid_num': 182},
        {'name': 'grand_place_brussels_3',
            'bundle_prefix': 'yfcc', 'valid_num': 239},
        {'name': 'milan_cathedral',    'bundle_prefix': 'yfcc', 'valid_num': 117},
        {'name': 'sacre_coeur',    'bundle_prefix': 'yfcc', 'valid_num': 1084},
        {'name': 'st_peters_basilica_interior_2',
            'bundle_prefix': 'yfcc', 'valid_num': 269},
        {'name': 'lincoln_memorial',    'bundle_prefix': 'yfcc', 'valid_num': 321},
        {'name': 'pieta_michelangelo',    'bundle_prefix': 'yfcc', 'valid_num': 134},
        {'name': 'st_peters_basilica_interior_1',
            'bundle_prefix': 'yfcc', 'valid_num': 540},
    ...
    yfcc_valid_list = [
        ...
        # {'name': 'national_gallery_london',
        #     'bundle_prefix': 'yfcc', 'valid_num': 290},
        {'name': 'sagrada_familia_2',    'bundle_prefix': 'yfcc', 'valid_num': 186},
        # {'name': 'hagia_sophia_interior',
        #     'bundle_prefix': 'yfcc', 'valid_num': 827},
        # {'name': 'sistine_chapel_ceiling_2',
        #     'bundle_prefix': 'yfcc', 'valid_num': 78},
        # {'name': 'paris_opera_2',    'bundle_prefix': 'yfcc', 'valid_num': 195},
        # {'name': 'london_bridge_1',    'bundle_prefix': 'yfcc', 'valid_num': 196},
        {'name': 'piazza_della_signoria',
            'bundle_prefix': 'yfcc', 'valid_num': 105}
    ]

    # train_yfcc = CaptureDataset_10x_edges(dataset_dir=yfcc_res_dir,
    #                             dataset_list=yfcc_train_list,
    #                             img_max_dim=400,
    #                             img_lmdb_paths=yfcc_lmdb_cache,
    #                             sample_res_cache=os.path.join(
    #                                 yfcc_res_dir, 'train_export_pred_edge_80_nodes.bin'),
    #                             sampling_num_range=[50, 100],
    #                             load_img=True,
    #                             load_keypt_match=True,
    #                             sampling_undefined_edge=False,
    #                             sub_graph_nodes=80)
    # valid_yfcc = CaptureDataset_10x_edges(dataset_dir=yfcc_res_dir,
    #                             dataset_list=yfcc_valid_list,
    #                             img_max_dim=400,
    #                             img_lmdb_paths=yfcc_lmdb_cache,
    #                             sample_res_cache=os.path.join(
    #                                 yfcc_res_dir, 'valid_3_30_nodes.bin'),
    #                             sampling_num_range=[50, 100],
    #                             load_img=True,
    #                             load_keypt_match=True,
    #                             sampling_undefined_edge=False,
    ...
    valid_set = ConcatDataset([valid_o_dataset])
...
if __name__ == '__main__':
    ...
    idx, img_names, imgs, img_ori_dim, cam_Es, cam_Ks, \
    out_graph_mat, img_id2sub_id, sub_id2img_id, out_covis_mat, \
    edge_subnode_idx, edge_type, edge_local_matches_n1, edge_local_matches_n2, \
    edge_rel_Rt = train_set[0]
