...
import numpy as np
import json
from data.capture.capt_data_noise_supergraph import SupergraphDataset
...
if 'cs-gruvi-24s' in server_name:
    datasets_config_filename = "/mnt/Tango/pg/pg_akt_rot_avg/exp/dataset_configs/dataset_config_24s.json"
...
def make_dataset(json_config, load_img, load_node_edge_feat,error=0.05,noise=10):
