...
class EdgeClassifier(nn.Module):
    ...
    def __init__(self, input_feat_channel=512, inplace=True):
...
class EdgeClassifier3(nn.Module):
    
    def __init__(self, input_feat_channel, input_local_feat_channel):
        super(EdgeClassifier3, self).__init__()
    ...
    def forward(self, gat_cat_feats, local_eg_feats):
        ...
        return self.fc2.forward(f)

    def forward_extract_feat(self, gat_cat_feats, local_eg_feats):
        x1 = self.fc.forward(gat_cat_feats)
        x2 = self.fc1.forward(local_eg_feats)
        f = torch.cat([x1, x2], dim=1)
        return self.fc2.forward(f), f


class EdgeClassifier5(nn.Module):

    def __init__(self, input_feat_channel, input_local_feat_channel):
        super(EdgeClassifier5, self).__init__()
...
class EdgeClassifier5_1label(nn.Module):

    def __init__(self, input_feat_channel, input_local_feat_channel):
        super(EdgeClassifier5_1label, self).__init__()
