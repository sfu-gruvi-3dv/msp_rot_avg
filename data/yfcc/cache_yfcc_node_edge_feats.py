...
from exp.make_yfcc_dataset import make_dataset
...
def add_samples_to_lmdb(dataset, lmdb, processed_edge_dict, processed_node_dict):
    ...
    for sample in train_loader:
        dataset_name, idx, img_names, imgs, img_ori_dim, cam_Es, cam_Ks, _, img_id2sub_id, sub_id2img_id, _, edge_subnode_idx, edge_type, edge_local_matches_n1, edge_local_matches_n2, edge_rel_Rt, _, _ = sample
