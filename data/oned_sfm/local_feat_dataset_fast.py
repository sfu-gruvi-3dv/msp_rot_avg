...
class OneDSFMDataset(Dataset):
    ...
    def __init__(self, iccv_res_dir, image_dir, dataset_list, lmdb_paths=None,
        ...
        if sample_res_cache is None or not os.path.exists(sample_res_cache):
            ...
            for ds_id, ds in enumerate(dataset_list):
                ...
                print('[1dsfm dataset Init] %s: (filtered: %d, all: %d)' % (
    ...
    def __getitem__(self, idx):
        ...
        return img_names, imgs, img_ori_dim, cam_Es, cam_Cs, cam_Ks, out_graph_mat, img_id2sub_id, sub_id2img_id, out_covis_mat, edge_subnode_idx, edge_type, edge_local_matches_n1, edge_local_matches_n2
...
if __name__ == '__main__':
    ...
    dataset = OneDSFMDataset(iccv_res_dir=iccv_res_dir, image_dir=image_dir, dataset_list=datalist,
                             sample_res_cache='/mnt/Tango/pg/ICCV15_raw/subgraph_cache.bin')
