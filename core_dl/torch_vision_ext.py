...
def heatmap_blend(img:torch.tensor, heatmap:torch.tensor, heatmap_blend_alpha=0.5, heatmap_clip_range=None, cmap='jet', chw_order=True):
    """
...
class UnNormalize(object):
    """ Inverse normalize the image for visualize """
    # Example:
